import {HomeIcon, BuildingLibraryIcon, PlusCircleIcon, HeartIcon, RssIcon, MagnifyingGlassIcon } from "@heroicons/react/24/outline"
  ...
  return (
    <div className="text-gray-500 px-5 pt-5 pb-36 text-xs lg:text-sm border-r border-gray-900 h-screen overflow-y-scroll scrollbar-hidden sm:max-w-[12rem] lg:max-w-[15rem] hidden md:block" >
      <div className="space-y-4">
        ...
        <Divider />
        <p className="cursor-pointer text-white">Playlist</p>
        <p className="cursor-pointer text-white">Playlist</p>
        <p className="cursor-pointer text-white">Playlist</p>
        <p className="cursor-pointer text-white">Playlist</p>
        <p className="cursor-pointer text-white">Playlist</p>
